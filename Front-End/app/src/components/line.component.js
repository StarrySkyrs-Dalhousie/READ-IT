            ...
            <ul class="list-group">
                {this.state.data.map((part)=>(
                    <li style={{background:'transparent', marginBottom:'10px', border:'none'}} class="list-group-item d-flex justify-content-between align-items-center">
                        {part.partName}
                        <div class="text-end">
                            <span style={{color:'black'}} class="badge bg-light rounded-pill">
                                Ordering {this.props.unit}
                            </span>
                            <span style={{marginLeft:'10px', color:'black'}} class="badge bg-light rounded-pill">
                                In store {part.part_QOH}
                            </span>
                        </div>
                    </li>
                ))}
